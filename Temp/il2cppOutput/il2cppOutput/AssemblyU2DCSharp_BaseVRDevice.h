...
struct  BaseVRDevice_t25  : public Object_t
{
	...
	CardboardProfile_t29 * ___U3CProfileU3Ek__BackingField_14;
};
struct BaseVRDevice_t25_StaticFields{
	// BaseVRDevice BaseVRDevice::device
	BaseVRDevice_t25 * ___device_0;
};
