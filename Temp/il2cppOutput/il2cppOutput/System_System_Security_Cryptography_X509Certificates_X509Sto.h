...
struct  X509Store_t1086  : public Object_t
{
	...
	X509Certificate2Collection_t1076 * ___list_2;
	...
	X509Store_t1102 * ___store_4;
};
struct X509Store_t1086_StaticFields{
	...
	Dictionary_2_t545 * ___U3CU3Ef__switch$mapF_5;
};
