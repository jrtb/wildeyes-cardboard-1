...
struct  SslStreamBase_t1344  : public Stream_t1315
{
	...
	ManualResetEvent_t1330 * ___negotiationComplete_13;
	...
	MemoryStream_t749 * ___recordStream_15;
};
struct SslStreamBase_t1344_StaticFields{
	// System.Threading.ManualResetEvent Mono.Security.Protocol.Tls.SslStreamBase::record_processing
	ManualResetEvent_t1330 * ___record_processing_2;
};
