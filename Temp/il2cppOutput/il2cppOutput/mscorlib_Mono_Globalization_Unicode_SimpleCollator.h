...
struct  SimpleCollator_t1449  : public Object_t
{
	...
	CodePointIndexer_t1434 * ___cjkIndexer_6;
	...
	CodePointIndexer_t1434 * ___cjkLv2Indexer_8;
...
struct SimpleCollator_t1449_StaticFields{
	...
	SimpleCollator_t1449 * ___invariant_1;
};
