...
struct  ComponentListPool_t347  : public Object_t
{
};
struct ComponentListPool_t347_StaticFields{
	...
	ObjectPool_1_t345 * ___s_ComponentListPool_0;
	...
	UnityAction_1_t346 * ___U3CU3Ef__am$cache1_1;
};
