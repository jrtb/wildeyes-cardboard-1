...
struct  X509EnhancedKeyUsageExtension_t1094  : public X509Extension_t1072
{
	...
	OidCollection_t1091 * ____enhKeyUsage_4;
...
struct X509EnhancedKeyUsageExtension_t1094_StaticFields{
	...
	Dictionary_2_t545 * ___U3CU3Ef__switch$mapE_6;
};
